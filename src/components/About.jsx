...
const stats = [
  ...
  { label: 'TECH STACK SIZE', value: '20+', accent: '#3671C6' },
  { label: 'LINES OF CODE', value: '10K+', accent: '#3671C6' },
  { label: 'CURRENT LAP', value: '2nd Year', accent: '#FFD700' },
]
...
function About() {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(circle_at_82%_50%,rgba(54,113,198,0.12),transparent_36%)]"
      />

      <div className="relative mx-auto max-w-7xl">
        <div className="mb-4 h-px w-full bg-gradient-to-r from-[#FFD700] via-[#FFD700]/55 to-transparent" />
        <p className="mb-12 font-mono text-[10px] font-bold tracking-[0.28em] text-white/45 uppercase sm:text-xs">
          <span className="text-[#FFD700]">02</span> — DRIVER PROFILE
        </p>
        ...
        <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-0">
          <div className="lg:border-r lg:border-[#FFD700]/45 lg:pr-10 xl:pr-14">
            ...
            >
              <div aria-hidden="true" className="absolute top-0 left-0 h-1 w-24 bg-[#FFD700]" />
              <div
                aria-hidden="true"
                className="absolute -right-2 top-10 select-none text-[clamp(10rem,23vw,17rem)] leading-none font-black italic tracking-[-0.09em] text-white/[0.035]"
              ...
              <div className="relative flex h-full flex-col">
                <div className="flex items-start justify-between gap-4">
                  <p className="font-mono text-[10px] font-bold tracking-[0.3em] text-[#FFD700] uppercase sm:text-xs">
                    Driver Profile
                  </p>
                  <span className="border border-[#3671C6]/60 bg-[#3671C6]/10 px-2 py-1 font-mono text-[9px] tracking-[0.18em] text-[#75a7ed] uppercase">
                    CIT / 44
                  </span>
                </div>

                <div className="mt-auto pt-28">
                  <p className="mb-2 font-mono text-[10px] tracking-[0.25em] text-white/35 uppercase">Driver</p>
                  <h2
                    id="about-heading"
                  ...
                  >
                    ANUP KUMAR <span className="text-[#3671C6]">JENA</span>
                  </h2>

                  <dl className="mt-8 divide-y divide-white/10 border-y border-white/10 font-mono text-xs">
                    <div className="grid grid-cols-[7rem_1fr] gap-3 py-3">
                      <dt className="text-[9px] tracking-[0.2em] text-white/35 uppercase">Nationality</dt>
                      <dd className="font-bold tracking-[0.1em]">🇮🇳 INDIAN</dd>
                    </div>
                    <div className="grid grid-cols-[7rem_1fr] gap-3 py-3">
                      <dt className="text-[9px] tracking-[0.2em] text-white/35 uppercase">Team</dt>
                    ...
                    <div className="grid grid-cols-[7rem_1fr] items-center gap-3 py-3">
                      <dt className="text-[9px] tracking-[0.2em] text-white/35 uppercase">Status</dt>
                      <dd className="flex items-center gap-2 font-bold tracking-wide text-[#FFD700]">
          ...
          <div className="flex flex-col justify-center lg:pl-10 xl:pl-14">
            <p className="font-mono text-[10px] font-bold tracking-[0.28em] text-[#FFD700] uppercase sm:text-xs">
              About the driver
            </p>
            <h3 className="mt-4 max-w-2xl text-3xl leading-tight font-black tracking-[-0.025em] uppercase sm:text-4xl">
              Engineering systems for the <span className="text-[#3671C6]">fast lane.</span>
            </h3>
            ...
            <div className="mt-10 grid grid-cols-2 border border-white/10 bg-[#0d1b2a]/80">
              {stats.map(({ label, value, accent }, index) => (
                ...
                >
                  ...
                  <p className="font-mono text-[8px] font-bold tracking-[0.18em] text-white/38 uppercase sm:text-[10px] sm:tracking-[0.22em]">
                    {label}
                  </p>
                  <p
                  ...
                  <div className="mt-4 flex items-center gap-1" aria-hidden="true">
                    {[0, 1, 2, 3, 4].map((bar) => (
                      <span
                        ...
                        style={{ backgroundColor: bar < 4 ? `${accent}99` : 'rgba(255,255,255,0.08)' }}
                      />
                    ))}
                  </div>
                </div>
